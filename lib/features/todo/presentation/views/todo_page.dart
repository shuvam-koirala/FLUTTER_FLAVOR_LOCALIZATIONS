...
import "package:flavor_localizations/features/todo/domain/entities/todo.dart";
import "package:flavor_localizations/features/todo/presentation/blocs/todo_bloc/todo_bloc.dart";

part 'todo_page_model.dart';
...
class _TodoPageState extends State<TodoPage> with TodoPageModel {
  @override
  void initState() {
                            ...
                            trailing: Wrap(
                              children: [
                                Checkbox.adaptive(
                                    ...
                                    onChanged: (value) {
                                      toogleCompletion(context, value, item);
                                    }),
                                IconButton(
                                    onPressed: () {
